...
//判断原密码是否正确
$num = $db->num("SELECT id FROM member WHERE id='".$member_owner_id."' and pwd='".md5($passwd_old)."'");
if(!$num){
...
//会员信息表更新
$query1 = $db->query("UPDATE member set nickname='".$nickname."',pwd='".md5($passwd_1)."' where id='".$member_owner_id."'");
if($query1){
	$result['REV'] = 1;
	$result['MSG'] = '您的信息修改成功!';
}
