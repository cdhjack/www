...
<div class="agent-infor">
    <form action="#" method="post">
        ...
        <input type="hidden" id="tx_base_64" name="tx_base_64" value=""/>
   	    ...
   	    <p><label>代理商：</label><input type="text" id="nickname" name="nickname" value="{*$member_arr.nickname*}" placeholder="请输入您的名称" onBlur="checkInput(this.id)"/></p>
        ...
        <p><label>房主数量：</label><input type="text" value="{*$member_arr.friend_count*}" readonly style=" color: #999;"/></p>
...
$('#button-agentinfo-1').bind('click', function() { 
	...
	$.ajax({
		url: '{*$site_url*}agent/agentInfoAction.php',
		type: 'post',
		dataType: 'json',
		data: {
