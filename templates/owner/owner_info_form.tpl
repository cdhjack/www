...
<div class="owner-infor">
    <form action="#" method="post">
        ...
        <input type="hidden" id="tx_base_64" name="tx_base_64" value=""/>
   	    ...
   	    <p><label>房主名：</label><input type="text" id="nickname" name="nickname" value="{*$member_arr.nickname*}" placeholder="请输入您的名称" onBlur="checkInput(this.id)"/></p>
...
$('#button-ownerinfo-1').bind('click', function() { 
	...
	$.ajax({
		url: '{*$site_url*}owner/ownerInfoAction.php',
		type: 'post',
		dataType: 'json',
		data: {
