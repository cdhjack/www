...
$sql = "SELECT a.id,a.member_id,a.amount,a.status,a.agent_id,a.add_time,a.pay_time,b.mobile,b.nickname,b.tx FROM order_pay_agent a LEFT JOIN member b ON a.member_id=b.id WHERE a.agent_id='".$member_agent_id."'";	
//echo $sql;exit;
$num = $db->num($sql);
...
$smarty->assign("title", "群订单-代理商收到的订单");
$smarty->view('agent/agent_orderlist.tpl');
?>