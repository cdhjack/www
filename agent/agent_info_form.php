...
//查询代理商信息
$sql = "SELECT a.id,a.mobile,a.nickname,a.rname,a.tx,a.identity,a.reg_time,b.member_type,b.invite_code,b.friend_count,b.wx_group_qrcode,b.balance,c.identity_pic,c.wx_nick,c.wx_tx,c.wx_pay_qrcode FROM member a LEFT JOIN member_info c ON a.id=c.member_id LEFT JOIN member_type b ON a.id=b.member_id and b.member_type=3 WHERE a.id='".$member_agent_id."'";
...
$smarty->assign("title", "代理商信息");
$smarty->view('agent/agent_info_form.tpl');
?>