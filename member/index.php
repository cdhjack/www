...
//查询玩家信息
$sql = "SELECT a.id,a.mobile,a.nickname,a.rname,a.tx,b.member_type,b.invite_code,b.friend_count,b.wx_group_qrcode,b.balance,(SELECT count(c.id) FROM order_pay_owner c WHERE c.member_id=a.id) as order_num FROM member a LEFT JOIN member_type b ON a.id=b.member_id and b.member_type=1 WHERE a.id='".$member_id."'";
...
$smarty->assign("title", "玩家");
$smarty->view('member/index.tpl');
?>