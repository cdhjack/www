        ...
        <div class="form1">
          <ul>
            ...
            <li><span class="yzm"><!--<img src="images/yzm.jpg"/>--><img id="captcha_1" alt="" src=""></span><a href="#" onClick="javascript:reloadcode_1();return false;"><img src="images/tb01.jpg"/></a>
              <input class="in1" id="checkcode_1" name="checkcode_1" type="text" value="验证码（必须填写）" onFocus="if(this.value=='验证码（必须填写）'){this.value='';}"  onblur="checkInput(this.id)" />
              <span id="form-checkcode_1-error" class="error"></span>
				<script type=""text/javascript"">
				document.getElementById("captcha_1").src = "{*$site_url*}public/captcha_mobile_reg.php?" + Math.random();
            ...
            <li>
              <input id="passwd_1" name="passwd_1" type="password" placeholder="请输入密码" value="" onBlur="checkInput(this.id)"/>
              <span id="form-passwd_1-error" class="error"></span>
            </li>
            <li>
              <!--<input class="in2" name="" type="text" value="短信验证码（必须填写）" onFocus="if(this.value=='短信验证码（必须填写）'){this.value='';}"  onblur="checkInput(this.id)" />
              <a class="link1" href="#">免费获取验证码</a> </li>-->
              <input id="repasswd_1" name="repasswd_1" type="password" placeholder="请再次输入密码" value="" onBlur="checkInput(this.id)"/>
              <span id="form-repasswd_1-error" class="error"></span>
            <li class="li1"><span class="f_r"><!--<a href="#">暂不开通注册</a>--></span>实名及防沉迷信息填写</li>
            <li>
              <input name="rname_1" id="rname_1" type="text" value="真实姓名（必须填写）" onFocus="if(this.value=='真实姓名（必须填写）'){this.value='';}"  onblur="checkInput(this.id)" />
              <span id="form-rname_1-error" class="error"></span>
            </li>
            <li>
              <input name="identity_1" id="identity_1" type="text" value="身份证号码（必须填写）" onFocus="if(this.value=='身份证号码（必须填写）'){this.value='';}"  onblur="checkInput(this.id)" />
              <span id="form-identity_1-error" class="error"></span>
            </li>
          </ul>
          <div class="in3">
            <input name="userselect_1" id="userselect_1" type="checkbox" onBlur="checkInput(this.id)">
            已阅读并同意用户协议
        ...
        <div class="form1">
          <ul>
            ...
            <li><span class="yzm"><!--<img src="images/yzm.jpg"/>--><img id="captcha_2" alt="" src=""></span><a href="#" onClick="javascript:reloadcode_2();return false;"><img src="images/tb01.jpg"/></a>
              <input class="in1" id="checkcode_2" name="checkcode_2" type="text" value="验证码（必须填写）" onFocus="if(this.value=='验证码（必须填写）'){this.value='';}"  onblur="checkInput(this.id)" />
              <span id="form-checkcode_2-error" class="error"></span>
				<script type=""text/javascript"">
				document.getElementById("captcha_2").src = "{*$site_url*}public/captcha_email_reg.php?" + Math.random();
            ...
            <li>
              <input id="passwd_2" name="passwd_2" type="password" placeholder="请输入密码" value="" onBlur="checkInput(this.id)"/>
              <span id="form-passwd_2-error" class="error"></span>
            </li>
            <li>
              <!--<input class="in2" name="" type="text" value="短信验证码（必须填写）" onFocus="if(this.value=='短信验证码（必须填写）'){this.value='';}"  onblur="checkInput(this.id)" />
              <a class="link1" href="#">免费获取验证码</a> </li>-->
              <input id="repasswd_2" name="repasswd_2" type="password" placeholder="请再次输入密码" value="" onBlur="checkInput(this.id)"/>
              <span id="form-repasswd_2-error" class="error"></span>
            <li class="li1"><span class="f_r"><!--<a href="#">暂不开通注册</a>--></span>实名及防沉迷信息填写</li>
            <li>
              <input name="rname_2" id="rname_2" type="text" value="真实姓名（必须填写）" onFocus="if(this.value=='真实姓名（必须填写）'){this.value='';}"  onblur="checkInput(this.id)" />
              <span id="form-rname_2-error" class="error"></span>
            </li>
            <li>
              <input name="identity_2" id="identity_2" type="text" value="身份证号码（必须填写）" onFocus="if(this.value=='身份证号码（必须填写）'){this.value='';}"  onblur="checkInput(this.id)" />
              <span id="form-identity_2-error" class="error"></span>
            </li>
          </ul>
          <div class="in3">
            <input name="userselect_2" id="userselect_2" type="checkbox" onBlur="checkInput(this.id)">
            已阅读并同意用户协议
...
$('#button-reg-1').bind('click', function() {
	...
	$.ajax({
		url: '{*$site_url*}regAction.php?membertype=1',
		type: 'post',
		dataType: 'json',
...
$('#mobile').bind('blur', function() {
	...
	var mobile_value = $('#mobile').val();
	$.ajax({
		url: '{*$site_url*}checkLoginName.php?membertype=1',
		type: 'post',
		dataType: 'json',
		data:{"mobile":mobile_value},
		beforeSend: function() {
...
$('#email').bind('blur', function() {	
	...
	$.ajax({
		url: '{*$site_url*}checkLoginName.php?membertype=2',
		type: 'post',
		dataType: 'json',
...
$('#button-reg-2').bind('click', function() {
	...
	$.ajax({
		url: '{*$site_url*}regAction.php?membertype=2',
		type: 'post',
		dataType: 'json',
		data:{"email":email_value,
