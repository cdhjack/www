<?php /* Smarty version Smarty-3.1.5, created on 2017-05-20 23:01:32
         compiled from "E:\www\www.chitugame.com\/templates/reg.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10852591ffc63e0e5c9-42194224%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '93c6751f7005193e3bf2fc7b0ea86f24b8cc2afd' => 
    array (
      0 => 'E:\\www\\www.chitugame.com\\/templates/reg.tpl',
      1 => 1495291823,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10852591ffc63e0e5c9-42194224',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.5',
  'unifunc' => 'content_591ffc63ecb24',
  'variables' => 
  array (
    'site_url' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_591ffc63ecb24')) {function content_591ffc63ecb24($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
      ...
      <div class="bd">
        <div class="form1">
          <ul>
            ...
            <li><span class="yzm"><img src="images/yzm.jpg"/></span><a href="#"><img src="images/tb01.jpg"/></a>
...
index.php';
				...
				$('#form-userselect_1-error').html(data.MSG);
			}
		}
	});
});
...
$('#mobile').bind('blur', function() {	
	...
	$.ajax({
		url: '<?php echo $_smarty_tpl->tpl_vars['site_url']->value;?>
ajax/checkLoginName.php?membertype=1',
		type: 'post',
		dataType: 'json',
		data:{"mobile":mobile_value},
		beforeSend: function() {
...
$('#email').bind('blur', function() {	
	...
	$.ajax({
		url: '<?php echo $_smarty_tpl->tpl_vars['site_url']->value;?>
ajax/checkLoginName.php?membertype=2',
		type: 'post',
		dataType: 'json',
...
index.php';
				...
				//alert(data.MSG);
				$('#form-userselect_2-error').html(data.MSG);
			}
		}
	});
});
